...
export const EPISODE_SLIDER_TRANSLATION_COEF_RESP = 92;
...
export const ICON_CIRCLE = 'fa fa-circle';
...
export const ICON_LINK = 'fas fa-external-link-alt';
...
export const PODCAST_DRIVE_IMG_LINK_SUFFIX = '/view';
...
export const PODCAST_DRIVE_IMG_LINK_RESOLVER = 'https://drive.google.com/uc?export=view&id=';
...
export const VIDEO_SLIDER_TRANSLATION_COEF_RESP = 84.4;
