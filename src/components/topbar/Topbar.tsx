...
const Topbar = () => {
  const [ scrollHeight, setScrollHeight ] = useState(
    interpolateScroll({ scrollPos: window.scrollY, acceleration: TOPBAR_INTERPOLATION_ACCEL })
  );
  ...
  const topbarOpacity : number = interpolateScroll({ scrollPos: scrollHeight, acceleration: TOPBAR_INTERPOLATION_ACCEL });
  console.log(topbarOpacity);

  return (
    <div className={styles.body} >
      <div className={styles.background} style={{ opacity: topbarOpacity }} />
      <img src={healinerLogo} alt="healiner_logo" className={styles.logoContainer}/>
      <div>
